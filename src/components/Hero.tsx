    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
      ...
      <div className="flex flex-col gap-6 md:gap-8 order-2 lg:order-1">
        ...
        <div className="flex flex-wrap items-center gap-4 mt-4">
          <Link
            to="/signup"
            className="px-8 py-4 bg-black text-white rounded-full font-bold text-sm tracking-widest uppercase hover:bg-gray-800 transition-all shadow-xl hover:shadow-2xl active:scale-95"
          >
            Launch Now
          </Link>
          <a
            href="#how-it-works"
            className="px-8 py-4 bg-gray-100 text-gray-500 rounded-full font-bold text-sm tracking-widest uppercase hover:bg-gray-200 transition-all"
          >
            How It Works
          </a>
        </div>
