        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 relative">
            <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-2xl ring-8 ring-white/5">
              <video
                ...
                muted
                playsInline
                poster="/images/showcase_main.png"
                className="w-full h-auto"
              >
                <source src="/images/selfservice.webm" type="video/webm" />
                <source src="/images/selfservice_optimized.mp4" type="video/mp4" />
          ...
          <div className="order-1 lg:order-2 flex flex-col gap-8 text-white">
            ...
            <div className="pt-4">
              <Link
                to="/signup"
                className="inline-block w-full md:w-auto px-10 py-5 bg-white text-black rounded-2xl font-bold text-sm tracking-widest uppercase hover:bg-gray-100 transition-all shadow-xl text-center"
              >
                Try Self-Provisioning
              </Link>
            </div>
          </div>
        </div>
