          ...
          <div className="bg-black rounded-[3rem] md:rounded-[4.5rem] p-12 md:p-24 lg:p-32 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center gap-8">
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 mt-4">
                <button className="px-12 py-6 bg-white text-black rounded-2xl font-black text-sm tracking-widest uppercase hover:bg-orange-500 hover:text-white transition-all shadow-2xl active:scale-95">
                  Start 14-Day Free Trial
                </button>
                <button className="px-12 py-6 bg-white/5 text-white rounded-2xl font-black text-sm tracking-widest uppercase border border-white/10 hover:bg-white/10 transition-all">
                  View a Live Demo
                </button>
              </div>
            </div>
