...
const App: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen text-gray-900 dark:text-white transition-colors duration-300">
      {/* Sidebar - fixed width */}
      <Sidebar />
      ...
      <main className="flex-1 p-8 lg:p-12 overflow-y-auto">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">Welcome in, <span className="font-semibold text-gray-900 dark:text-gray-200">Ops Manager</span>. Here is the performance report for today, Sep 24, 2024.</p>
          </div>
        ...
        {/* Dynamic Metric Progress Bar Section */}
        ...
        <footer className="mt-12 flex justify-between items-center text-gray-400 dark:text-gray-600 text-sm border-t border-gray-300/40 dark:border-white/5 pt-8">
           <p>© 2024 EHCX.ai CCaaS Analytics</p>
